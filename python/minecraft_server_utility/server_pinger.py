...
class ServerPinger:
    ...
    def ping(self) -> Dict[str, Any]:
        ...
        try:
            ...
            raise InvalidServerException(f"Error pinging server: invalid response ({e})")
    ...
    def __repr__(self) -> str:
        return f"ServerPinger(host={self.host!r}, port={self.port}, timeout={self.timeout})"

    def __str__(self) -> str:
        return f"ServerPinger({self.host}:{self.port})"
